...
## Paso 1: Construcción de un agente
...
El agente debería devolver una respuesta basada en el mensaje recibido. Si la respuesta tiene el tono y el formato esperados, el flujo base está listo para extenderse en el Paso 2.

![image](./images/image%2036.png)

---

## Paso 2: Flujo completo con una base de datos
...
### Paso 2.8 — Prueba del flujo completo
