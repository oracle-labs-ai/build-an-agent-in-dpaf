# Instalación de AI Private Agent Factory

Esta guía describe los requisitos y el proceso de despliegue inicial de Oracle AI Database Private Agent Factory.
...
En los campos **username** y **password** escribe los campos según el usuario que creamos anteriormente.
...
```
Is your database server deployed in an air-gapped environment (no access to the public internet)?
No
Are the OCI certificates added to the wallet?
Yes
```
...
En el siguiente paso presiona *Instalar*.
...
En el paso 3 será necesario configurar el modelo de lenguaje.
