...
1. **Políticas IAM** para autorizar a las instancias a consumir servicios de IA.
    ...
    > Si no existen, crea las políticas necesarias siguiendo [este tutorial](../oci-console-tutorials/Creación%20de%20una%20política.md).

2. **Un compartment** para agrupar los recursos creados durante el laboratorio.

    > Si no tienes uno, crea el compartment siguiendo [este tutorial](../oci-console-tutorials/Creación%20de%20un%20compartment.md).
...
3. **Base de datos Oracle con capacidades de IA**
    ...
    > Si no tienes una base de datos, crea una Autonomous Database 26ai [siguiendo este tutorial](../oci-console-tutorials/Crear%20base%20de%20datos%20autónoma.md).
...
4. **Credenciales para acceso a servicios de Inteligencia Artificial**
    ...
    > Si no tienes credenciales, crea y descarga el API Key [siguiendo este tutorial](../oci-console-tutorials/Creación%20de%20credenciales.md).

5. **Red virtual de OCI** con una VCN, subred pública y reglas de ingreso para DPAF.

    > Si todavía no tienes la red, configúrala siguiendo [este tutorial](../oci-console-tutorials/Creación%20de%20una%20red.md).
...
![image 40](AI%20Private%20Agent%20Factory/image%2041.png)

Seleccionando el compartment 

![image 40](AI%20Private%20Agent%20Factory/image%2042.png)

Y luego la base de datos

![image 40](AI%20Private%20Agent%20Factory/image%2043.png)
...
![image.png](AI%20Private%20Agent%20Factory/image%2044.png)
...
![image.png](AI%20Private%20Agent%20Factory/image%2045.png)
